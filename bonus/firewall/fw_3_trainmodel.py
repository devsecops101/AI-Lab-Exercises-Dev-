...
def train_model(features_path, model_save_path='model'):
    ...
    model.save(f'/home/student/labs/bonus/firewall/model/detection_model.keras')
...
if __name__ == "__main__":
    ...
    model, scaler = train_model('/home/student/labs/bonus/firewall/logs/firewall_features.csv')
